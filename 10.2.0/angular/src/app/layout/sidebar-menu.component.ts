...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l('Ritesh Project'), '', 'fas fa-project-diagram', '', [
                new MenuItem('Hospital', '', 'fas fa-hospital', '', [
                    new MenuItem(this.l('PatientAdmissions'), '/app/PatientAdmission', 'fas fa-procedures'),
                    new MenuItem(this.l('Patients'), '/app/Patients', 'fas fa-user-injured'),
                    new MenuItem(this.l('Doctors'), '/app/Doctors', 'fas fa-user-doctor'),
                    new MenuItem(this.l('Rooms'), '/app/rooms', 'fas fa-home'),
                    new MenuItem(this.l('Bed'), '/app/Bed', 'fas fa-bed'),
                ]),
                new MenuItem('Student', '', 'fas fa-university', '', [
