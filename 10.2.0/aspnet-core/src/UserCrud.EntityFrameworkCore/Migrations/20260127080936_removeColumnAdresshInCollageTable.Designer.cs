...
namespace UserCrud.Migrations
{
    ...
    [Migration("20260127080936_removeColumnAdresshInCollageTable")]
    partial class removeColumnAdresshInCollageTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserCrud.Cities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserCrud.Collages.Collage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserCrud.States.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserCrud.Collages.Collage", b =>
                {
                    b.HasOne("UserCrud.Cities.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("UserCrud.Students.Student", b =>
                {
                    ...
                    b.HasOne("UserCrud.Collages.Collage", "Collage")
                        .WithMany()
                        .HasForeignKey("CollageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserCrud.Countries.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserCrud.States.State", "State")
                        .WithMany()
